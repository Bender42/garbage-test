...
public class SQLiteActivity extends AppCompatActivity {
    ...
    View.OnClickListener getSqlAddListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Long id = database.insert(Wallet.WALLET_TABLE_NAME, null, contentValues);
    ...
    View.OnClickListener getSqlClearListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SQLiteDatabase database = dbHelper.getWritableDatabase();
                int countClear = database.delete(Wallet.WALLET_TABLE_NAME, null, null);
    ...
    View.OnClickListener getSqlDeleteListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SQLiteDatabase database = dbHelper.getWritableDatabase();
                int countDelete = database.delete(Wallet.WALLET_TABLE_NAME, "id = ?", new String[] { textId });
    ...
    View.OnClickListener getSqlUpdateListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int idUpdate = database.update(Wallet.WALLET_TABLE_NAME, contentValues, "id = ?", new String[] { textId });
